...
export default function TabBar({ current }: TabBarProps) {
  ...
  return (
    <View className={`${appShellFixedClass} bottom-0 z-50 border-t border-[rgba(17,24,39,0.04)] bg-white/90 px-[0.5rem] pb-[calc(env(safe-area-inset-bottom)+0.375rem)] pt-[0.375rem] shadow-[0_-0.5rem_1.5rem_rgba(124,58,237,0.05)] backdrop-blur-[1.25rem]`}>
      {true && (
