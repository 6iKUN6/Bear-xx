    ...
    >
      {messages.length === 0 ? (
        <View className='flex min-h-full flex-col items-center justify-center px-[1.5rem] pt-[4.5rem] text-center box-border'>
          <View className='app-float relative mb-[1.75rem]'>
            <View className='app-icon-tile h-[6rem] w-[6rem] rounded-[1.75rem] text-[3.5rem] shadow-[0_1.25rem_3.125rem_rgba(124,58,237,0.28)]'>
              <Text className='leading-none'>🐻</Text>
            </View>
            <View className='app-gradient-surface-warm app-twinkle absolute -right-[0.375rem] -top-[0.375rem] flex h-[2.375rem] w-[2.375rem] items-center justify-center rounded-full text-[1.125rem] shadow-[0_0.625rem_1.5rem_rgba(251,146,60,0.3)]'>
              <Text className='leading-none'>✦</Text>
            </View>
          </View>
          <Text className='app-gradient-text mb-[0.625rem] block text-[1.5rem] font-bold leading-[1.2]'>
            嗨，我是 Litter Bear
          </Text>
